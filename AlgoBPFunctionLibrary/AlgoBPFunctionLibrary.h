...
UCLASS()
class OUTERWILDS_API UAlgoBPFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
	 ...
	 * @param bIsPredSatisfied Bool ref to PredSatisfied: this must be manipulated inside Predicate function
	 * @param InPredicateName Predicate Name to search for in the Outer Object Map functions list
	 */
public:
	UFUNCTION(BlueprintCallable, Category = "Predicate Blueprint Functions", DisplayName = "FindByPredicate_ConstObject",
		meta = (CustomStructureParam = "InElementsToCheck", DefaultToSelf = "InOuter"))
	static UPARAM(DisplayName = "Found UObject") const UObject* BP_FindByPredicate_ConstObject(UObject* InOuter,
		...
		UPARAM(ref) bool& bIsPredSatisfied, const FName& InPredicateName);
	...
	static UPARAM(DisplayName = "Found UObject") UObject* BP_FindByPredicate_Object(UObject* InOuter,
		UPARAM(ref) TArray<UObject*>& InElementsToCheck,
		UPARAM(ref) bool& bIsPredSatisfied, const FName& InPredicateName);
	...
	static UPARAM(DisplayName = "Found Instanced Struct Array") TArray<UObject*> BP_FilterByPredicate_Object(
		UObject* InOuter,
		const TArray<UObject*>& InElementsToCheck, UPARAM(ref) bool& bIsPredSatisfied,
		const FName& InPredicateName = "");
	...
	static UPARAM(DisplayName = "Found Instanced Struct") FInstancedStruct BP_FindByPredicate_Struct(UObject* InOuter,
		TArray<FInstancedStruct> InElementsToCheck, UPARAM(ref) bool& bIsPredSatisfied,
		const FName& InPredicateName = "");  
